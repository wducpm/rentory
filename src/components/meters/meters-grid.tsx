...
import { Droplets, PencilRuler, Zap } from "lucide-react";
            ...
            >
              ...
              {row.contract ? (
                ...
                <p className="text-muted-foreground mt-2 text-xs">
                  Mốc hiện tại: <span className="tabular">{row.currentElec}</span>{" "}
                  điện · <span className="tabular">{row.currentWater}</span> nước.
                  Phòng trống không sinh hóa đơn (HD-05).
                </p>
              )}
